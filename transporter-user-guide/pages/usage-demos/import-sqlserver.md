...
Acquire data from tables <i>entity</i> and <i>relation</i> from SQL Server database <i>test</i>, import into Ultipa graphset <i>shareholding</i>:

<center><img width="800" src="https://img.ultipa.cn/img/2023-12-11-16-13-30-sqlserver.png"></center>
<center><i>From SQL Server to Ultipa</i></center>
...
<p tit="import.sample.sqlserver.yml" type="yaml"></p>
...
```bash
./ultipa-importer --config ./import.sample.sqlserver.yml
```
