...
Read node files <i>person.json</i> and <i>company.json</i> and edge file <i>holding.json</i> from SFTP or local directory, import into Ultipa graphset <i>shareholding</i>:

<center><img width="800" src="https://img.ultipa.cn/img/2023-12-12-18-16-16-json.png"></center>
<center><i>From JSON to Ultipa</i></center>
