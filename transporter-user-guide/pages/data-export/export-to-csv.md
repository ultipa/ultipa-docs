...
This page demonstrates the process of exporting data from a graph in Ultipa to CSV file(s).

<center><img width="800" src="https://img.ultipa.cn/img/2025-03-06-14-40-35-export-csv.png"></center>
...
- `sftp`: Configure the SFTP server where the CSV files will be stored. If you will export to your local machine, remove this section or leave it blank.
...
nodeConfig:
  ...
  - schema: "Customer"
    # Specify the properties; if unset, all properties will be exported
    properties:
      - name: name
      - name: level
  - schema: "Merchant"
...
settings:
  ...
  fileType: csv
  # Whether to include a header in the file
  writeHeader: true
...
<center><img style="margin-top:0;" src="https://img.ultipa.cn/img/2025-03-06-14-43-44-csv-export.png"></center>
