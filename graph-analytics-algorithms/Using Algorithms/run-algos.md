...
| --- | --- | --- | --- |
| Task Writeback | `write()` | Run the algorithm as <a href="https://www.ultipa.com/document/ultipa-graph-query-language/backend-task">task</a>; you can specify that algorithm results are written back to file (RPC interface) or property, and any algorithm statistics, if available, are written to task information | Not supported |
