...
ArticleRank has been derived from <a href="https://www.ultipa.com/document/ultipa-graph-analytics-algorithms/pagerank">PageRank</a> to measure the influence of journal articles.
...
However, not all articles are equally important. Hence, this approach based on <a href="https://www.ultipa.com/document/ultipa-graph-analytics-algorithms/pagerank">PageRank</a> was proposed to rank articles.
...
| weaken | int | `1`, `2` | `1` | No | For ArticleRank, keep it as `2`; `1` means to run <a href="https://www.ultipa.com/document/ultipa-graph-analytics-algorithms/pagerank">PageRank</a> |
