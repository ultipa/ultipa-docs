...
- In many scenarios, considering the percentage of neighbors rather than a fixed number of neighbors (such as the <i>k</i> value in <a href="https://www.ultipa.cn/document/ultipa-graph-analytics-algorithms/k-core">k-Core</a>) is more appropriate due to variations in node degrees. 
