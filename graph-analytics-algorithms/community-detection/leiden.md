...
The concept of modularity, as explained in the <a target="_blank" href="/docs/graph-analytics-algorithms/louvain">Louvain</a> algorithm, is also used in the Leiden algorithm. However, Leiden introduces a new **resolution parameter** `γ ` (gamma) into the modularity formula:
