...
- In a complex graph where multiple edges can exist between two nodes, the triangles in a truss are counted by edges. Please also refer to the <a href="/docs/graph-analytics-algorithms/triangle-counting">Triangle Counting</a> algorithm.
