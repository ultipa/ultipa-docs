...
| `dest()` | `<filter?>` | The filtering condition enclosed in `{}`, or an alias to specify the set of nodes as traversal destinations. If left blank, all nodes are targeted. | No | `NODE` |
...
<div align=center drawio-diagram='19515' drawio-name='draw_dc44ff8e727a4a799e04dfff152fe24f.jpg'><img src="https://img.ultipa.cn/draw/draw_dc44ff8e727a4a799e04dfff152fe24f.jpg?v='1731556015626'"/></div>
