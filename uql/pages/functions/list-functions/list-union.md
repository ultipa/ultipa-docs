...
Function `listUnion()` merges and deduplicates the elements of two <i>list</i>s, and returns them as a new <i>list</i>, namely, returns the union of these two <i>list</i>s (repeated elements are NOT allowed in the union).
