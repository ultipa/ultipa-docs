...
Function `difference()` calculates the elements that exist in the 1st <i>list</i> but not in the 2nd <i>list</i> and returns them as a new <i>list</i>, namely, returns the difference of these two <i>list</i>s (repeated elements are allowed in the difference).
