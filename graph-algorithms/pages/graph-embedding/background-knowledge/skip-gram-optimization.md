...
The <a target="_blank" href="/docs/graph-algorithms/skip-gram">basic Skip-gram model</a> is nearly impractical for real-world use due to its high computational demands. 
