...
| <a href="#List-Operators">List Operators</a> | <a href="#List-Construction">List Construction</a>: `[]` or `LIST[]` or `ARRAY[]`<br><a href="#Elements-Accessing">Elements Accessing</a>: `[]`<br><a href="#Membership-Checking">Membership Checking</a>: `IN`<br><a href="#List-Concatenation">List Concatenation</a>: `\|\|` |
