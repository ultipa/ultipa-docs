...
```groovy
implementation 'com.ultipa:ultipa-gqldb-driver:6.x.x'
```

> Replace `6.x.x` with the latest version from <a href="https://mvnrepository.com/artifact/com.ultipa/ultipa-gqldb-driver" target="_blank">Maven Central</a>.
