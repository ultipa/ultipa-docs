...
<table>
  <tbody style="vertical-align: top;">
    ...
    <tr>
      <td colspan="2"><a href="https://www.ultipa.com/doc/drivers/python-uql-execution"><b>UQL Execution</b></a><ul>
        <li>uql()</li>
    ...
    <tr>
      <td><a href="https://www.ultipa.com/doc/drivers/python-graphset-management"><b>Graphset Management</b></a><ul>
        <li>showGraph()</li>
        <li>getGraph()</li>
        <li>createGraph()</li>
      ...
      <td><a href="https://www.ultipa.com/doc/drivers/python-schema-and-property-management"><b>Schema and Property Management</a></b><ul>
        <li>showSchema()</li>
        <li>getSchema()</li>
    ...
    <tr>
      <td><a href="https://www.ultipa.com/doc/drivers/python-data-insertion-and-deletion"><b>Data Insertion and Deletion</a></b><ul>
        <li>insertNodes()</li>
        <li>insertEdges()</li>
      ...
      <td><a href="https://www.ultipa.com/doc/drivers/python-query-acceleration"><b>Query Acceleration</a></b><ul>
        <li>lte()</li>
        <li>ufe()</li>
        <li>showIndex()</li>
        <li>showNodeIndex()</li>
    ...
    <tr>
      <td><a href="https://www.ultipa.com/doc/drivers/python-algorithm-management"><b>Algorithm Management</a></b><ul>
        <li>showAlgo()</li>
        <li>installAlgo()</li>
        <li>uninstallAlgo()</li>
        <li>showExta()</li>
      ...
      <td><a href="https://www.ultipa.com/doc/drivers/python-downloads-and-exports/"><b>Downloads and Exports</a></b><ul>
        <li>downloadAlgoResultFile()</li>
        <li>downloadAllAlgoResultFile()</li>
        <li>export()</li></ul></td>
    </tr>
    <tr>
      <td><a href="https://www.ultipa.com/doc/drivers/python-process-and-task-management"><b>Process and Task Management</a></b><ul>
        <li>top()</li>
        <li>kill()</li>
        <li>showTask()</li>
        <li>clearTask()</li>
        <li>stopTask()</li></ul></td>
      <td><a href="https://www.ultipa.com/doc/drivers/python-access-management"><b>Access Management</a></b><ul>
        <li>showPrivilege()</li>
        <li>showPolicy()</li>
        <li>getPolicy()</li>
        <li>createPolicy()</li>
    ...
    <tr>
      <td><a href="https://www.ultipa.com/doc/drivers/python-others"><b>Others</a></b><ul>
        <li>stats()</li>
        <li>test()</li></ul></td>
      <td></td>
    </tr>
...
Lastly, if you are retrieving a large amount of data from the database, it is recommended to use the <a href="https://www.ultipa.com/doc/drivers/python-uql-execution#uqlStream()">the `uqlStream()` method</a> to processes the result set incrementally.
