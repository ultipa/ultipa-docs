...
Details of creating graph model can be found in documentation of [GraphSet](https://www.ultipa.com/document/ultipa-graph-query-language/graphset), [Schema](https://www.ultipa.com/document/ultipa-graph-query-language/schema), [Property](https://www.ultipa.com/document/ultipa-graph-query-language/property).
...
Click and read about [Unique Identifier](https://www.ultipa.com/document/ultipa-graph-query-language/unique-identifier) of metadata.
...
Details of inserting metadata can be found in documentation of [Insert](https://www.ultipa.com/document/ultipa-graph-query-language/insert), [Overwrite](https://www.ultipa.com/document/ultipa-graph-query-language/overwrite), [Upsert](https://www.ultipa.com/document/ultipa-graph-query-language/upsert).
...
For batch import of data from CSV files or other databases, please refer to article [Data Import](https://www.ultipa.com/document/quick-start/data-import).
...
- Describe in `nodes()` or `edges()` the metadata to be updated (review article [Graph Data](https://www.ultipa.com/document/quick-start/graph-data) on how to describe nodes and edges in UQL)
...
> Command `update()` is used to modify property values of metadata, but not to rename properties. Renaming properties, schemas, or graphsets belongs to the category of modifying graph models, see details in documentation of [GraphSet](https://www.ultipa.com/document/ultipa-graph-query-language/graphset), [Schema](https://www.ultipa.com/document/ultipa-graph-query-language/schema), [Property](https://www.ultipa.com/document/ultipa-graph-query-language/property).
